This guide is currently only valid for WINDOWS, but it does not deal with all problems you may encounter. It will most likely be similar for MAC OS/LINUX. 
 
 1) Put this folder (called beamers) with .sty-files inside 
